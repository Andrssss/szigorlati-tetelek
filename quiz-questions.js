        ...
        topics: [
            ...
            /* ---------- 1. Téma ---------- */
            {
                ...
                questions: [
                    ...
                    { q: "Mi jellemzi az IPA (Nemzetközi Fonetikus Ábécé) jelrendszerét?", a: ["Latin ábécén alapul; a magyarban kb. 14 magánhangzót és 24 mássalhangzót különböztet meg", "Görög betűkön alapul; csak 26 jele van", "Kizárólag mássalhangzókat jelöl", "A japán kana ábécéből ered"], correct: 0 },
                    ...
                    { q: "Melyik kódolási szabványt nevezik Latin-2-nek, és mire terjed ki?", a: ["ISO 8859-2, amely a kelet-európai (pl. magyar, cseh, lengyel) karaktereket kódolja", "ASCII, amely csak az angol betűket tartalmazza", "UTF-8, amely az összes Unicode karaktert lefedi", "ISO 8859-1, amely a nyugat-európai karaktereket tartalmazza"], correct: 0 },
                    { q: "Melyik diakritikum-kódolási módszer a 'repülő ékezetes' megoldás?", a: ["Vesszőkkel (aposztróf-szerű karakterekkel) helyettesíti az ékezetes betűket: a' e' o' stb.", "Minden ékezetes betűt számkóddal ír le, pl. &#225;", "Az ékezetes betűt egyszerűen elhagyja", "HTML-entitásokat használ, pl. &aacute;"], correct: 0 },
                    ...
                    { q: "Hány karaktert tartalmaz a Unicode 16.0 szabvány, és hány írásrendszert fed le?", a: ["154 998 karaktert, 159 írásrendszert", "65 536 karaktert, 26 írásrendszert", "1 114 112 karaktert, 300 írásrendszert", "128 karaktert, 1 írásrendszert"], correct: 0 },
                    { q: "Melyik Unicode-blokk tartalmazza a székely rovásírás jeleit?", a: ["U+10C80 (Old Hungarian) blokk", "U+0000 (Basic Latin) blokk", "U+FB00 (Alphabetic Presentation Forms) blokk", "U+4E00 (CJK Unified Ideographs) blokk"], correct: 0 },
                    { q: "Hány szabályból áll a Magyar Tudományos Akadémia betűrendezési előírása?", a: ["8 szabályból", "3 szabályból", "26 szabályból", "16 szabályból"], correct: 0 },
                    { q: "Miért rövid a Morse-kódban az 'E' betű jele (egyetlen pont)?", a: ["Mert az E a leggyakoribb betű az angolban, és a Morse a rövid jeleket a leggyakoribb betűkhöz rendeli", "Mert az E egyszerű betű, könnyű leírni", "Mert a Morse-kód ábécérendben jelöli a betűket", "Mert az E ritkán fordul elő, ezért kap egyszerű jelet"], correct: 0 },
                    ...
                    { q: "Miért nem javul a felismerési pontosság 4-gramnál nagyobb n esetén kis (8 MB-os) korpuszon?", a: ["Mert a 4-gramok és hosszabb sorozatok annyira ritkák, hogy nincs elég adat a megbízható becsléshez", "Mert 4-gram után az n-gramok nem hordoznak új információt", "Mert 4-gramnál a számítás exponenciálisan lassul", "Mert a magyar nyelvben csak 4 szó van mondatonként"], correct: 0 },
                    ...
                    { q: "Mi a 'betűsorrend-olvashatóság' jelenség lényege?", a: ["Ha egy szóban az első és az utolsó betű a helyén van, a közbülső betűk felcserélése alig ront az érthetőségen", "A szavak csak akkor érthetők, ha minden betűjük a helyes sorrendben áll", "A nagybetűk olvasása lassabb, mint a kisbetűké", "Csak rövid (3 betűs) szavaknál igaz, hogy sorrendtől függetlenül olvashatók"], correct: 0 },
                    { q: "Miért tükrözi a QWERTY-billentyűzet az angol betűgyakoriságot?", a: ["A tipikus (angol) betűsorozatokat úgy rendezi el, hogy felváltva két kézzel lehessen gépelni, csökkentve a mechanikus akadást", "A QWERTY a legritkább betűket teszi a legkönnyebben elérhető helyekre", "A QWERTY ábécérendben helyezi el a billentyűket", "A QWERTY-t kizárólag a jobb kéz használatára tervezték"], correct: 0 },
                    { q: "Hány karaktert tud kódolni az UTF-16?", a: ["1 112 064 karaktert (a teljes Unicode-tartomány, surrogate pair-ekkel)", "65 536 karaktert (csak az alap BMP síkot)", "128 karaktert (ASCII)", "4 294 967 296 karaktert (UCS-4/UTF-32)"], correct: 0 },
            ...
            /* ---------- 2. Téma ---------- */
            {
                ...
                questions: [
                    ...
                    { q: "Melyik évet és szerzőt köti a tételleírás az FST-k fonológiában való alkalmazásához?", a: ["Johnson, 1972 – ő ismerte fel, hogy a fonológiai szabályok reguláris relációk", "Chomsky, 1957 – a Syntactic Structures-ban vezette be", "Koskenniemi, 1983 – a kétszintes morfológia kapcsán", "Jelinek, 1990 – a statisztikai nyelvmodellek fejlesztésekor"], correct: 0 }
                ]
            },
            ...
            /* ---------- 3. Téma ---------- */
            {
                ...
                questions: [
                    { q: "Ki dolgozta ki a kétszintes morfológiai modellt, és mikor?", a: ["Koskenniemi, 1983-ban – a két szint a lexikális (morfémák) és a felszíni (szóalakok) szint", "Chomsky, 1957-ben – a Syntactic Structures keretein belül", "Johnson, 1972-ben – a fonológiai szabályok leírásakor", "Kaplan és Kay, 1994-ben – az FST-kompozíció kapcsán"], correct: 0 },
                    ...
                    { q: "Miért nem fogadja el a HuMor a *főnökban alakot?", a: ["A főnök töve [MÉLYHANGRENDŰ−] jegyű (magas hangrendű), a -ban rag viszont [MÉLYHANGRENDŰ+] értéket vár – az unifikáció sikertelen", "Mert a főnök szónak nincs -ban ragozása a szótárban", "Mert a főnök kétszótagos, és ilyen tőhöz nem kapcsolódhat -ban", "Mert a -ban rag csak igékhez kapcsolódhat"], correct: 0 },
            ...
            /* ---------- 4. Téma ---------- */
            {
                ...
                questions: [
                    ...
                    { q: "Mi a fejjegyek (head features) és a lábjegyek (foot features) különbsége? Adj példát!", a: ["A fejjegyek (pl. szám, személy) az egész szerkezeten végigvonulnak; a lábjegyek csak az aktuális művelethez kellenek, pl. az a/az névelő megválasztása (következő szó magán- vagy mássalhangzóval kezdődik-e)", "A fejjegyek csak az igékre, a lábjegyek csak a főnevekre vonatkoznak", "A fejjegyek az ige vonzatkeretét írják le, a lábjegyek a hangtani tulajdonságokat", "A két fogalom között nincs különbség, szinonimaként használhatók"], correct: 0 },
                    { q: "Hogyan fejezi ki a tételleírás az egyeztetési jegy-azonosságot a DAG-alapú leírásban?", a: ["Nem a jegynek van értéke önmagában, hanem az odavezető DAG-ösvénynek: az alany és az állítmány SZÁM-ösvényének végén lévő értéknek kell megegyeznie", "Az egyeztetési jegyet külön listában kell felsorolni minden mondattípushoz", "A DAG-ban minden egyes egyeztetési eset külön szabályt igényel", "Az egyeztetés jelölésmódjától teljesen függetlenül működik"], correct: 0 }
                ]
            },
            ...
            /* ---------- 5. Téma ---------- */
            {
                ...
                questions: [
                    ...
                    { q: "Hány synsete van az angol 'bass' szónak a WordNetben, és miért jelent ez kihívást?", a: ["8 synset (pl. basszus hang, basszus szólam, bőgő, sósvízi hal stb.) – a poliszémia eldöntése (mi külön synset?) szubjektív döntést igényel az ontológus részéről", "Pontosan 2 synset: 'zene' és 'hal' értelmezés", "Minden szónak pontosan 1 synsete van, ezért nincs kihívás", "A 'bass' szónak nincs synsete, mert tulajdonnév"], correct: 0 },
                    { q: "Hogyan kapcsolódik a Magyar WordNet az EuroWordNethez?", a: ["Az EuroWordNet nyelvek közötti összeköttetést egy Inter-Lingual Index (ILI) biztosít; ehhez csatlakozik a Balkanet, amelyen keresztül a Magyar WordNet (~42 000 fogalom) is elérhető", "A Magyar WordNet közvetlenül a Princeton WordNetből van lefordítva, ILI nélkül", "A Magyar WordNet és az EuroWordNet teljesen független, nincs köztük kapcsolat", "Az ILI kizárólag szóalakokat tartalmaz, nem fogalmakat"], correct: 0 },
                    ...
                    { q: "Mi a tartományi (domain) ontológia viszonya a felső ontológiához?", a: ["A tartományi ontológia (pl. orvosi, jogi, biológiai) a felső ontológiára kapcsolódik és örökli annak kategóriáit, csak specifikus fogalmakat ad hozzá", "A tartományi ontológia teljesen független a felső ontológiától", "A felső ontológia a tartomány-specifikus adatokat tartalmazza, a tartományi az általánosakat", "Minden természetes nyelvhez külön felső ontológia szükséges"], correct: 0 },
            ...
            /* ---------- 6. Téma ---------- */
            {
                ...
                questions: [
                    ...
                    { q: "Mikor jelent meg az első igazi korpusz (Brown korpusz), és mekkora volt?", a: ["1961-ben; 1 millió szó; az első szisztematikusan összeállított, géppel kereshető angol korpusz", "1990-ben; 1 milliárd szó; ez a Magyar Nemzeti Szövegtár elődje", "1957-ben; 10 000 szó; Chomsky Syntactic Structures-éhez gyűjtötték", "2001-ben; 100 millió szó; az internetes kereső motorok adatbázisából"], correct: 0 },
                    { q: "Mekkora a Magyar Nemzeti Szövegtár jelenlegi mérete, és mit jelent ez a hibaarány szempontjából?", a: ["Elérte az 1 milliárd tokent; 1‰ hibaarány is 1 millió hibás adatot jelent, de elegendő helyes adat marad a tanításhoz", "500 millió szó; a hibaarány irreleváns ekkora adatbázisban", "5 milliárd szó; hibaarány nulla, mert kézzel ellenőrzött", "100 millió szó; ez elegendő az összes magyar szóalak megismeréséhez"], correct: 0 },
                    { q: "Mi a párhuzamos korpusz, és mi a két legrégibb példa rá?", a: ["Két vagy több nyelv egymásnak megfeleltetett szöveggyűjteménye; a Rosetta-kő (i.e. 196, Champollion fejtette meg a hieroglifákat) és a Biblia (a legrégebbi sok-nyelvi párhuzamos korpusz)", "Egynyelvű korpusz, amelyet két kutatócsoport egymástól függetlenül gyűjtött össze", "Morfológiailag és szintaktikailag is annotált korpusz", "Két különböző időszakból származó azonos nyelvű szöveggyűjtemény"], correct: 0 },
                    ...
                    { q: "Hogyan működik a fuzzy match a fordítómemóriában?", a: ["Minden TM-mondathoz trigram-alapú numerikus fuzzy kulcsot generálnak; kereséskor a lekérdező mondat indexéhez a legkisebb távolságú indexbeli mondatot adja vissza, egy maximális 'fuzzyságon' belül; normalizálás (kisbetűsítés, nem-alf. karakterek eltávolítása) a kompakt tárolásért", "A fuzzy match az összes TM-mondatot összehasonlítja szavanként, és a legtöbb egyező szót tartalmazót adja vissza", "A fuzzy kulcs mindig pontosan 32 bites hash", "A fuzzy match kizárólag 100%-os egyezéseket talál meg"], correct: 0 },
                    { q: "Mire valók a TMX, SRX és XLIFF szabványok?", a: ["TMX: TM-ek XML-alapú cseréje eszközök között (1.4b verzió, tu/seg kétszintű struktúra); SRX: a TMX-hez tartozó szegmentálási szabályok exportja; XLIFF: egységes XML-csereformátum lokalizációs feladatokhoz", "Mindhárom szabvány a gépi fordítórendszerek kimeneti formátumát rögzíti", "TMX = szóbeágyazás formátuma; SRX = szintaktikai elemzési szabályok; XLIFF = szótárak cseréje", "Ezek kizárólag a Trados fordítóeszközben használt belső formátumok"], correct: 0 },
                    ...
                    { q: "Ki fejlesztette a SYSTRAN gépi fordítót, és ki használta sokáig?", a: ["Peter Toma; sokáig az EU és a Google használta, sok nyelvpárra kiterjedt", "Frederick Jelinek az IBM-nél; kizárólag angol–francia fordításra", "Mikolov Tamás; a word2vec szóbeágyazással kombinálva", "Fillmore; az interlingva-alapú rendszer megvalósítójaként"], correct: 0 },
            ...
            /* ---------- 7. Különbségek ---------- */
            {
                name: "★ Különbségek és fogalmi elhatárolások",
                questions: [
                    { q: "Mi a különbség a betű és a karakter között?", a: ["A betű lingvisztikai egység (fonémát jelöl); a karakter informatikai egység (kódponthoz rendelt jel)", "Nincs különbség", "A karakter mindig betű", "A betű kódszámmal rendelkezik, a karakter nem"], correct: 0 },
                    { q: "Mi a különbség a karakterkód és a kódlap között?", a: ["A karakterkód egy jel sorszáma egy adott karakterkészleten belül; a kódlap a kódok és bitkombinációk konkrét megfeleltetési táblázata", "Megegyeznek", "A kódlap a szoftver neve", "A karakterkód csak ASCII-ra vonatkozik"], correct: 0 },
                    { q: "Mi a különbség az UTF-8 és az UTF-16 között?", a: ["UTF-8 változó hosszúságú (1–6 bájt), ASCII-kompatibilis; UTF-16 fix 2 vagy 4 bájtot használ és 1 112 064 karaktert kódol", "Az UTF-16 ASCII-kompatibilis, az UTF-8 nem", "Mindkettő mindig pontosan 2 bájtot használ", "Az UTF-8 csak latin betűket, az UTF-16 minden Unicode karaktert kódol"], correct: 0 },
                    ...
                    { q: "Mi a különbség a corpus-based és corpus-driven megközelítés között?", a: ["Corpus-based: előzetes hipotézist tesztel a korpuszon; corpus-driven: az adatból bontakoztatja ki az elméletet (serendipity principle)", "Mindkettő azonos, eltérő szerzők eltérő neveket alkalmaznak rá", "A corpus-driven előzetes hipotézist tesztel, a corpus-based nem", "A corpus-based nem használ szövegkorpuszt, csak szótárakat"], correct: 0 },
                    ...
                    { q: "Mi a különbség a fejjegyek (head features) és a lábjegyek (foot features) között?", a: ["A fejjegyek (szám, személy, eset) az egész mondatszerkezeten végigvonulnak; a lábjegyek (pl. a/az névelő megválasztása) csak lokálisan, az aktuális szintaktikai műveletnél kellenek", "A fejjegyek csak igéknél, a lábjegyek csak főneveknél fordulnak elő", "Mindkettő a szó hangsúlyszerkezetét írja le", "A fejjegyek az elemző bemenetén, a lábjegyek a kimenetén szerepelnek"], correct: 0 },
                    { q: "Mi a különbség a token és a type között?", a: ["A token az összes szóelőfordulás száma a szövegben; a type a különböző szóalakok száma (pl. 'ház' 5×-ös előfordulása 5 token, de 1 type)", "Megegyeznek nagy korpuszban", "A type mindig nagyobb, mint a token", "A token a betű, a type a morféma"], correct: 0 },
                    { q: "Mi a különbség a pontosság (precision) és a fedés (recall) között a szövegszinkronizációban?", a: ["Precision: az összerendelt mondatpárok közül hány helyes; recall: az összes valóban megfelelő pár közül hányat sikerült megtalálni – a kettő ellentétesen mozog (trade-off)", "Mindkettő ugyanazt méri, csak más névvel", "A precision mindig nagyobb, mint a recall", "A recall a fordítás minőségét, a precision a sebességét méri"], correct: 0 },
                    { q: "Mi a különbség a hosszalapú és a horgonyalapú szinkronizáció között?", a: ["A hosszalapú (Gale–Church) a mondathossz korrelációján alapul, teljes szinkronizációt ad (magas recall, kissé alacsonyabb precision); a horgonyalapú fix egyező elemeket (URL, szám) használ, közel 100%-os precision-nel de részleges lefedéssel", "A horgonyalapú teljes szinkronizációt ad, a hosszalapú részlegest", "Mindkettő azonos precision-nel és recall-lal rendelkezik", "A hosszalapú kétnyelvű szótárt igényel, a horgonyalapú nem"], correct: 0 }
                ]
            }
        ]
    }
